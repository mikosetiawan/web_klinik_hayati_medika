...
<head>
  ...
  <title>
    Registrasi Akun | Klinik Hayati Medika
  </title>
  <!--     Fonts and icons     -->
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
      <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="../pages/dashboard.html">
        <img src="{{ asset('assets/img/logo_klinik.png') }}" alt="" class="w-25 rounded-circle">
      </a>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              <h1 class="text-white mb-2 mt-5">Selamat datang di!</h1>
              <p class="text-lead text-white">Klinik Hayati Medika. Silahkan registrasi isi dulu ya!</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="card-body">
                {{-- <form role="form text-left"> --}}
                  <form method="POST" role="form text-left" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                      <input id="nik" class="form-control" placeholder="NIK" type="number" name="nik"
                        :value="old('nik')" required autofocus autocomplete="nik">
                      <x-input-error :messages="$errors->get('nik')" class="mt-2" />
                    </div>
                    <div class="mb-3">
                      <input id="name" class="form-control" placeholder="Username" type="text" name="name"
                    ...
                    <div class="mb-3">
                      <input id="password_confirmation" class="form-control" placeholder="Konfirmasi Password"
                    ...
                    {{-- Role --}}
                    <div class="mb-3">
                      <input id="role" type="hidden" name="role" value="pasien">
